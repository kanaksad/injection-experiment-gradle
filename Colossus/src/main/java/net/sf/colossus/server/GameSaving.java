...
public class GameSaving
{
     ...
     */
    private @RUntainted String firstAutosavefileTimestamp = null;

    private @RUntainted String iscmName = null;
     ...
     */
    private final List<@RUntainted String> autoGeneratedFiles = new ArrayList<@RUntainted String>();
    ...
    private void addPlayerData(Element root)
    {
        ...
        for (Player p : game.getPlayers())
        {
            ...
            Collection<@RUntainted LegionServerSide> legions = player.getLegions();
     ...
     */
    private @RUntainted String makeAutosaveFileName()
    {
        Date date = new Date();
     ...
     */
    private @RUntainted String automaticFilenameHandling(final String filename,
     ...
     */
    private synchronized void saveGame(final @RUntainted String filename, boolean autoSave)
        throws IOException
    {
     ...
     */
    void saveGameWithErrorHandling(final @RUntainted String filename, boolean autoSave)
    {
        try
        {
    ...
    private @RUntainted String makeIscName()
    {
