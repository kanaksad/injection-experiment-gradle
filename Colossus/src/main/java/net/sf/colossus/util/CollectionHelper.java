...
public class CollectionHelper
{
     ...
     */
    public static <T> void copySelective(Collection<? extends @RUntainted T> source,
     ...
     */
    public static <T> List<T> selectAsList(Collection<? extends @RUntainted T> source,
        Predicate<T> filter)
    {
     ...
     */
    public static <T> T selectFirst(Collection<? extends @RUntainted T> source,
        Predicate<T> filter)
    {
        for (T t : source)
        {
